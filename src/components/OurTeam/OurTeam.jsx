  ...
  return (
    <>
      <Banner
        ...
        title='Meet the faces behind iT Cart!'
        bodytext='We are a group of professionals with a specialized skill-set, developed over years of high functioning work in demanding scenarios!
      ...
      <section className="pb-5 ourteam pt-6">
        <Container className='bg-light6 px-6 pt-5 pb-7 rounded-8' fluid="xxl">
          ...
          <Row className="gx-9">
            <Col xs={12} md={4} ref={ref}>
              <SlideCard onClick={handleClick} classBody="p-0" className="box-shadow-sm text-start ourteam">
            ...
            <Col xs={12} md={4} ref={ref}>
              <SlideCard onClick={handleClick} classBody="p-0" className="box-shadow-sm text-start">
                <img src={Team1} alt="" className="img-fluid" />
                <div className='py-3 px-3'>
