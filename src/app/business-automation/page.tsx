...
export const metadata: Metadata = {
  title: 'Business Automation Services - Streamline Operations | Devora',
  description: 'Automate your business processes and streamline operations with our comprehensive business automation services. Increase efficiency, reduce costs, and scale your business with intelligent automation solutions.',
  keywords: [
    'Business Automation',
    'Process Automation',
    'Workflow Automation',
  ...
  openGraph: {
    title: 'Business Automation Services - Streamline Operations | Devora',
    description: 'Automate your business processes and streamline operations with our comprehensive business automation services.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Business Automation Services by Devora',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Business Automation Services - Streamline Operations',
    description: 'Automate your business processes and streamline operations with our comprehensive business automation services.',
    images: ['/logo512.png'],
  },
  alternates: {
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 mb-6 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2.5 text-sm font-medium text-white/90 border border-white/20">
              <Zap className="w-4 h-4 text-[#6F8F72]" />
            ...
            <p className="text-xl leading-relaxed text-white/80 max-w-3xl mx-auto">
              Automate your business processes and streamline operations with our comprehensive business automation services. Increase efficiency, reduce costs, and scale your business with intelligent automation solutions.
            </p>
          </div>
        </div>
      </section>
