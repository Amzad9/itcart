...
export const metadata: Metadata = {
  title: 'Blog - Technology Insights & Expert Analysis | Devora',
  description: 'Explore our blog for expert insights, technology trends, and domain-specific guides tailored for growing businesses. Stay updated with Devora\'s latest thoughts and analysis.',
  keywords: [
    'Technology Blog',
    'IT Insights',
  ...
  openGraph: {
    title: 'Blog - Technology Insights & Expert Analysis | Devora',
    description: 'Explore our blog for expert insights, technology trends, and domain-specific guides tailored for growing businesses.',
    type: 'website',
    url: '/blog',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Blog - Technology Insights & Expert Analysis',
    description: 'Explore our blog for expert insights, technology trends, and domain-specific guides.',
    images: ['/logo512.png'],
  },
  alternates: {
    canonical: '/blog',
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 mb-6 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2.5 text-sm font-medium text-white/90 border border-white/20">
              <BookOpen className="w-4 h-4 text-[#6F8F72]" />
              Technology Insights
            </div>
