...
export const metadata: Metadata = {
  title: 'Case Studies - Success Stories & Transformations | Devora',
  description: 'Discover transformative case studies showcasing how companies have achieved success with Devora\'s solutions. Real stories of digital transformation and business growth.',
  keywords: [
    'Case Studies',
    'Success Stories',
    'Customer Success',
  ...
  openGraph: {
    title: 'Case Studies - Success Stories & Transformations | Devora',
    description: 'Discover transformative case studies showcasing how companies have achieved success with Devora\'s solutions.',
    type: 'website',
    url: '/case-studies',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Devora Case Studies',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Case Studies - Success Stories & Transformations',
    description: 'Discover transformative case studies showcasing how companies have achieved success with Devora.',
    images: ['/logo512.png'],
  },
  alternates: {
