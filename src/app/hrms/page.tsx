...
export const metadata: Metadata = {
  title: 'HRMS - Human Resource Management System | Devora',
  description: 'Streamline your HR operations with our comprehensive Human Resource Management System. Manage employees, recruitment, attendance, leaves, payroll, and more with Devora\'s HRMS solution.',
  keywords: [
    'HRMS',
  ...
  openGraph: {
    title: 'HRMS - Human Resource Management System | Devora',
    description: 'Streamline your HR operations with our comprehensive Human Resource Management System.',
    type: 'website',
    url: '/hrms',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Streamline your HR operations with our comprehensive HRMS solution.',
    images: ['/logo512.png'],
  },
  alternates: {
    canonical: '/hrms',
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed text-white/80 max-w-3xl mx-auto">
              Streamline your HR operations with our comprehensive Human Resource Management System. Manage employees, recruitment, attendance, leaves, payroll, and more all in one place.
            </p>
          </div>
        </div>
      </section>
