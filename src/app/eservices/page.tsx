...
export const metadata: Metadata = {
  title: 'E-Services - Digital Service Solutions | Devora',
  description: 'Transform your business processes with our E-Services automation platform. Manage document changes, business change requests, non-conformity reporting, IT service requests, and capital expenditure approvals.',
  keywords: [
    'E-Services',
    'Digital Services',
    'Document Management',
  ...
  openGraph: {
    title: 'E-Services - Digital Service Solutions | Devora',
    description: 'Transform your business processes with our E-Services automation platform.',
    type: 'website',
    url: '/eservices',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'E-Services Solution by Devora',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'E-Services - Digital Service Solutions',
    description: 'Transform your business processes with our E-Services automation platform.',
    images: ['/logo512.png'],
  },
  alternates: {
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed text-white/80 max-w-3xl mx-auto">
              Transform your business processes with our E-Services automation platform. Manage document changes, business change requests, and service approvals all in one place.
            </p>
          </div>
        </div>
      </section>
